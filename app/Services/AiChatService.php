...
class AiChatService
{
    ...
    protected function buildSystemPrompt(string $productsContext): string
    {
        ...
        return <<<PROMPT
You are a friendly and helpful AI assistant for {$businessName}'s WhatsApp customer service.
...
Remember: You're chatting on WhatsApp, so keep it casual and friendly!
PROMPT;
    }
