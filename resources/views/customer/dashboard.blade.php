    ...
    <div class="space-y-6">
        ...
        <div class="bg-[#0f1c2e] border border-white/10 rounded-xl p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                @if(isset($activeStore) && $activeStore)
                <a href="{{ $activeStore->domain ? 'https://' . $activeStore->domain : route('store.home', $activeStore->subdomain) }}" target="_blank" class="flex flex-col items-center gap-2 p-4 bg-white/5 hover:bg-white/10 rounded-lg transition">
                    <div class="p-3 bg-cyan-500/20 rounded-lg">
                        <svg class="w-6 h-6 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
