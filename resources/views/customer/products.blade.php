                            ...
                            <tr class="hover:bg-white/5 transition">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium sticky right-0 bg-[#0f1c2e] shadow-[-4px_0_8px_-4px_rgba(0,0,0,0.3)]">
                                    <div class="flex items-center justify-end gap-2">
                                        @if($store)
                                        <a href="{{ $store->domain ? 'https://' . $store->domain . '/product/' . $product->slug : route('store.product.show', [$store->subdomain, $product->slug]) }}" target="_blank" class="text-blue-400 hover:text-blue-300 transition" title="View Product Page">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                            </svg>
