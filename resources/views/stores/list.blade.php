                                ...
                                <div class="border border-gray-200 rounded-lg p-4 hover:border-blue-300 transition {{ $currentStoreId == $store->id ? 'bg-blue-50 border-blue-300' : '' }}">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <a href="{{ $store->domain ? 'https://' . $store->domain : route('store.home', $store->subdomain) }}" target="_blank" class="px-4 py-2 bg-emerald-100 text-emerald-700 text-sm font-medium rounded hover:bg-emerald-200 transition flex items-center gap-2" title="Visit Store Website">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
