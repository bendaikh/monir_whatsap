                ...
                <aside class="w-64 bg-white border-r border-gray-200 flex flex-col" x-data="{ open: true }">
                    ...
                    <nav class="flex-1 overflow-y-auto py-4 px-3">
                        <div class="space-y-1">
                            ...
                            <!-- AI Settings -->
                            <a href="{{ route('app.ai-settings') }}" class="{{ request()->routeIs('app.ai-settings') ? 'bg-emerald-50 text-emerald-700' : 'text-gray-700 hover:bg-gray-50' }} flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
